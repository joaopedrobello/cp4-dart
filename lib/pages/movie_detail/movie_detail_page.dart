...
import 'package:movie_app/pages/cast_detail/cast_detail_page.dart';
...
class _MovieDetailPageState extends State<MovieDetailPage> {
  ...
  late Future<KeywordsList> keywordsModel;
  ...
  fetchInitialData() {
    ...
    keywordsModel = apiServices.getMovieKeywords(widget.movieId);
    setState(() {});
  }
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        FutureBuilder(
                            future: keywordsModel,
                            builder: (context, snapshot) {
                              if (snapshot.hasData) {
                                final keywords = snapshot.data;

                                String keywordsText = keywords!.keywords
